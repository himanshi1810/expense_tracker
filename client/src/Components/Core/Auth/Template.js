      ...
      {loading ? (
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col-reverse justify-evenly gap-y-12 py-12 md:flex-row md:gap-y-0 md:gap-x-12">
          <div className="relative mx-auto w-11/12 max-w-[450px] md:mx-0">
            <img
              src={img} // Make sure to include the img prop here
              alt="logo"
              width={700}
              height={700}
              loading="lazy"
          ...
          <div className="mx-auto w-11/12 max-w-[450px] md:mx-0 ml-12">
            <h1 className="text-[1.875rem] font-semibold leading-[2.375rem] text-white">
              {title}
              <span className="text-[1.875rem] font-semibold leading-[2.375rem] text-primary">
                {title2}
              </span>
            </h1>
            <p className="mt-4 text-[1.125rem] leading-[1.625rem]">
              <span className="text-grey-100">{description1}</span>{" "}
            </p>
